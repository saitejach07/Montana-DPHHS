        ...
        <Card className="mb-8 overflow-hidden border-0 shadow-xl relative">
          <CardContent className="p-0">
            ...
            <div className="absolute inset-0 opacity-20">
              <ImageWithFallback 
                src="https://images.unsplash.com/photo-1762075314731-43d62a33c1f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnb3Zlcm5tZW50JTIwb2ZmaWNlJTIwcHJvZmVzc2lvbmFsfGVufDF8fHx8MTc2MzU5MzY3Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                alt="Government Office Professional"
